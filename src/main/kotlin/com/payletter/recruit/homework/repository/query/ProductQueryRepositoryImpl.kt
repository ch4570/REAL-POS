...
import com.payletter.recruit.homework.domain.entity.QCategoryJpaEntity.*
import com.payletter.recruit.homework.domain.entity.QProductJpaEntity.*
import com.payletter.recruit.homework.domain.entity.QProductSearchJpaEntity.*
...
class ProductQueryRepositoryImpl(
    ...
    override fun loadProductListByInitialKeyword(prevProductId: Long?, searchKeyword: String?) : List<ProductResponse> {
        val keyword = productSearchRepository.findByProductSearchKeyword("%$searchKeyword%").productSearchKeyword
